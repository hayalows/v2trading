(()=>{
  ...
  function render(){
    ...
    if(!mi){card.innerHTML='<div class="v34MapHead"><div><span>Market map</span><strong>Building higher-timeframe context</strong></div><small>Research context only</small></div>';return}
