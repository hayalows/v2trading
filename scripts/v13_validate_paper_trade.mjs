...
function firstFutureFill(bars,bosIdx,entry){
  const eligible=bars.slice(bosIdx+1,bosIdx+1+8);
...
console.log('v1.3 paper-trade validation passed: frozen risk math, future-only entry, history recovery, ambiguity guard, private journal tables and chart overlays present');