...
for(const phrase of ['WAIT FOR POI','What must happen next','Historical revisit context','not a forecast for this trade','Conditional POI revisit research','AUC was <strong>0.627</strong>','not a current-trade probability','Plan formed with supportive HTF','Current detector is Stage'])if(!js.includes(phrase))throw new Error(`missing focus/research behavior: ${phrase}`);
