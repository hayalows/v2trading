...
for(const phrase of ['WAIT FOR POI','What must happen next','Historical revisit context','not a forecast for this trade'])if(!js.includes(phrase))throw new Error(`missing focus behavior: ${phrase}`);
