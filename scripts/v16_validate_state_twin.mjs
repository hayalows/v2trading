...
for(const marker of ['v16-state-twin.js','/web/v16.css','focusBoard','evidenceView'])if(!html.includes(marker))throw new Error(`missing StateTwin HTML marker: ${marker}`);
