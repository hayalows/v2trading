...
const requiredHtml=['Version 1.2.1','POI Watch','Independent prospective evidence','Independence gate','Formation campaign','Sweep event','Fresh POI','Data trust','v11.css','v12.js','poi-watch.js','aria-label="Primary navigation"','role="status"'];
for(const m of requiredHtml)if(!html.includes(m))throw new Error(`Missing v1.2.1 HTML marker: ${m}`);
